...
2. [Route parameters](#2-route-parameters-endpoints)
3. [Query syntax](#3-query-syntax)
4. [Query operators](#operators)
5. [Collection rules](#4-collection-rules)
6. [Methods](#2-methods)
...
| :query        | ?        | To filter records with [query syntax](#query-syntax).  |
| :rules        | ?        | To add [collection rules](#collection-rules).          |
